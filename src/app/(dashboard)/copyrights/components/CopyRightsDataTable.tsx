...
export const copyrightsColumns: ColumnDef<Copyright>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const copyrightsData = row.original;
            return copyrightsData && copyrightsData.link && (
                <Link className="ms-2 text-blue-600" href={copyrightsData.link}>
                    {copyrightsData.link.length > 30 ? `${copyrightsData.link.substring(0, 45)}...` : copyrightsData.link}
                </Link>
            )
        },
                ...
                <Table>
                    ...
                    <TableBody>
                        {table.getRowModel().rows?.length ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={copyrightsColumns.length} className="h-24 text-center">
                                    No results.
                                </TableCell>
                            </TableRow>
                        )}
