    ...
    <div>
      <header className="header">
        <div className="header__container">
          ...
          {/* <img src="/images/logo.png" alt="logo" className="header__img" /> */}
          <Link href="/" className="header__logo">
          <Image src={"/images/logo.png"}  alt="logo" width={112} height={50} />
          </Link>
          ...
          <div>
            ...
            <div className="nav__list">
              <div className="nav__items">
                ...
                <Link href="/earnings" className="nav__link " onClick={handleLinkClick}>
